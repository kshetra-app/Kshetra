...
const styles = StyleSheet.create({
  ...
  headerLeft: { flex: 1 },
  title: { fontSize: 17, fontWeight: '800', color: '#FFFFFF', lineHeight: 22 },
  ...
  preamble: { fontSize: 13, color: '#9CA3AF', lineHeight: 18, marginBottom: 12, fontStyle: 'italic' },
  itemCard: { backgroundColor: '#0D1117', borderRadius: 12, padding: 12, marginBottom: 8, borderWidth: 1, borderColor: '#1F293780' },
  ...
  itemTitle: { fontSize: 14, fontWeight: '700', color: '#E5E7EB', marginBottom: 2 },
  itemDesc: { fontSize: 12, color: '#9CA3AF', lineHeight: 17, marginBottom: 6 },
  itemMeta: { flexDirection: 'row', gap: 12, marginBottom: 8 },
  metaText: { fontSize: 11, color: '#6B7280' },
  voteSection: { borderTopWidth: 1, borderTopColor: '#1F2937', paddingTop: 8 },
  ...
  votePct: { fontSize: 11, color: '#6B7280', fontWeight: '600' },
