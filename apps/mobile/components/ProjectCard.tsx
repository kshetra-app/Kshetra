...
const styles = StyleSheet.create({
  card: { backgroundColor: '#FFFFFF', borderRadius: 16, marginHorizontal: 16, marginVertical: 6, padding: 14, borderWidth: 1, borderColor: '#E8DED1', elevation: 2, shadowColor: '#241814', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.05, shadowRadius: 6 },
  ...
  name: { fontSize: 16, fontWeight: '800', color: '#241814', marginBottom: 2 },
  location: { fontSize: 11, color: '#988275', marginBottom: 4 },
  description: { fontSize: 13, color: '#6D5549', lineHeight: 18, marginBottom: 10 },
  progressSection: { marginBottom: 10 },
  progressRow: { flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 6 },
  progressLabel: { fontSize: 11, color: '#6D5549', width: 56 },
  progressBar: { flex: 1, height: 6, backgroundColor: '#E8DED1', borderRadius: 3, overflow: 'hidden' },
  progressFill: { height: '100%', borderRadius: 3 },
  progressPct: { fontSize: 12, fontWeight: '700', color: '#241814', width: 36, textAlign: 'right' },
  costRow: { flexDirection: 'row', justifyContent: 'space-around', marginBottom: 10, paddingVertical: 8, backgroundColor: '#F5EFE4', borderRadius: 8, borderWidth: 1, borderColor: '#E8DED1' },
  costItem: { alignItems: 'center' },
  costLabel: { fontSize: 10, color: '#988275' },
  costValue: { fontSize: 14, fontWeight: '800', color: '#241814', marginTop: 2 },
  footer: { flexDirection: 'row', justifyContent: 'space-between', paddingTop: 8, borderTopWidth: 1, borderTopColor: '#E8DED1' },
  footerItem: { flexDirection: 'row', alignItems: 'center', gap: 4 },
  footerText: { fontSize: 11, color: '#988275' },
  ...
  issuesRow: { flexDirection: 'row', alignItems: 'center', gap: 6, marginTop: 8, padding: 8, backgroundColor: '#FBE8E7', borderRadius: 8, borderWidth: 1, borderColor: '#E8DED1' },
  issueText: { fontSize: 11, color: '#A8201A', flex: 1 },
});
