...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 18, fontWeight: '900', color: '#FFFFFF', marginBottom: 14 },
  kpiRow: { flexDirection: 'row', justifyContent: 'space-around', marginBottom: 14, paddingVertical: 10, backgroundColor: '#0D1117', borderRadius: 12 },
  kpi: { alignItems: 'center', gap: 4 },
  kpiValue: { fontSize: 18, fontWeight: '900', color: '#FFFFFF' },
  kpiLabel: { fontSize: 10, color: '#6B7280', fontWeight: '600' },
  summaryRow: { flexDirection: 'row', justifyContent: 'space-around', marginBottom: 16, paddingTop: 10, borderTopWidth: 1, borderTopColor: '#1F2937' },
  summaryItem: { alignItems: 'center' },
  summaryValue: { fontSize: 16, fontWeight: '800', color: '#FFFFFF' },
  summaryLabel: { fontSize: 9, color: '#6B7280', fontWeight: '600' },
  sectionTitle: { fontSize: 13, fontWeight: '700', color: '#9CA3AF', marginBottom: 8, marginTop: 4 },
  formatRow: { flexDirection: 'row', alignItems: 'center', gap: 6, marginBottom: 6 },
  formatName: { fontSize: 11, color: '#D1D5DB', width: 80 },
  formatBar: { flex: 1, height: 6, backgroundColor: '#1F2937', borderRadius: 3, overflow: 'hidden' },
  formatBarFill: { height: '100%', backgroundColor: '#4F8EF7', borderRadius: 3 },
  formatAmount: { fontSize: 11, fontWeight: '700', color: '#FFFFFF', width: 50, textAlign: 'right' },
  ...
  monthValue: { fontSize: 10, fontWeight: '700', color: '#FFFFFF' },
  unitEcon: { paddingTop: 10, borderTopWidth: 1, borderTopColor: '#1F2937' },
  unitRow: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 4 },
  unitLabel: { fontSize: 11, color: '#6B7280' },
});
