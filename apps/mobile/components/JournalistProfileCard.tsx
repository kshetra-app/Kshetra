...
const styles = StyleSheet.create({
  ...
  outlet: { fontSize: 12, color: '#6B7280', marginTop: 2 },
  bio: { fontSize: 13, color: '#9CA3AF', lineHeight: 18, marginBottom: 10 },
  ...
  statsRow: { flexDirection: 'row', justifyContent: 'space-around', paddingTop: 12, borderTopWidth: 1, borderTopColor: '#1F2937' },
  stat: { alignItems: 'center' },
  statValue: { fontSize: 15, fontWeight: '800', color: '#FFFFFF' },
  statLabel: { fontSize: 10, color: '#6B7280', marginTop: 2 },
  badgesRow: { flexDirection: 'row', gap: 6, flexWrap: 'wrap', marginTop: 10, paddingTop: 10, borderTopWidth: 1, borderTopColor: '#1F2937' },
