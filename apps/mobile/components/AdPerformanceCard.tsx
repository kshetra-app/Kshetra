...
const styles = StyleSheet.create({
  ...
  name: { fontSize: 15, fontWeight: '700', color: '#241814', marginBottom: 2 },
  headline: { fontSize: 12, color: '#6D5549', marginBottom: 12 },
  kpiRow: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 12, paddingVertical: 8, backgroundColor: '#F5EFE4', borderRadius: 10, paddingHorizontal: 12 },
  kpi: { alignItems: 'center' },
  kpiValue: { fontSize: 15, fontWeight: '800', color: '#241814' },
  kpiLabel: { fontSize: 9, color: '#988275', marginTop: 2, fontWeight: '600' },
  sentimentRow: { flexDirection: 'row', alignItems: 'center', gap: 6, marginBottom: 8 },
  sentimentLabel: { fontSize: 11, color: '#988275', fontWeight: '600' },
  ...
  complianceRow: { flexDirection: 'row', alignItems: 'center', gap: 4, paddingTop: 8, borderTopWidth: 1, borderTopColor: '#E8DED1' },
  complianceText: { fontSize: 11, fontWeight: '700' },
  disclosureText: { fontSize: 10, color: '#988275', flex: 1, textAlign: 'right' },
