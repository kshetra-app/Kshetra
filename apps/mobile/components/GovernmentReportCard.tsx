...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontSize: 18, fontWeight: '800', color: '#241814' },
  ...
  pdiLabel: { fontSize: 10, fontWeight: '700', color: '#988275' },
  pdiInfo: { flex: 1 },
  pdiRating: { fontSize: 16, fontWeight: '800' },
  pdiDescription: { fontSize: 11, color: '#988275', lineHeight: 16, marginTop: 4 },
  pdiAvg: { fontSize: 12, color: '#6D5549', fontWeight: '700', marginTop: 6 },
  // Sections
  section: { marginBottom: 16 },
  sectionTitle: { fontSize: 14, fontWeight: '700', color: '#241814', marginBottom: 8 },
  // Status
  statusGrid: { gap: 6 },
  statusItem: {
    flexDirection: 'row',
  ...
  statusName: { fontSize: 11, color: '#6D5549', fontWeight: '600' },
  ...
  categoryCount: { fontSize: 10, fontWeight: '800', color: '#6D5549' },
  // Top items
