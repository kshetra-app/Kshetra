...
const styles = StyleSheet.create({
  ...
  avatarLarge: { width: 52, height: 52, borderRadius: 26, backgroundColor: '#1F2937', borderWidth: 2, justifyContent: 'center', alignItems: 'center' },
  avatarLargeText: { fontSize: 20, fontWeight: '800', color: '#FFFFFF' },
  headerInfo: { flex: 1 },
  ...
  partyLabel: { fontSize: 12, color: '#9CA3AF', fontWeight: '600' },
  location: { fontSize: 11, color: '#6B7280', marginTop: 2 },
  bio: { fontSize: 13, color: '#9CA3AF', lineHeight: 18, marginBottom: 12 },
  metricsRow: { flexDirection: 'row', justifyContent: 'space-between', paddingTop: 12, borderTopWidth: 1, borderTopColor: '#1F2937' },
  ...
  responseRow: { flexDirection: 'row', alignItems: 'center', gap: 6, marginTop: 10, padding: 8, backgroundColor: '#1F293740', borderRadius: 8 },
  responseText: { fontSize: 12, color: '#6B7280' },
  compactCard: { flexDirection: 'row', alignItems: 'center', gap: 10, padding: 12, backgroundColor: '#111827', borderRadius: 10, borderWidth: 1, borderColor: '#1F2937' },
  avatar: { width: 36, height: 36, borderRadius: 18, backgroundColor: '#1F2937', borderWidth: 2, justifyContent: 'center', alignItems: 'center' },
  avatarText: { fontSize: 14, fontWeight: '800', color: '#FFFFFF' },
  compactInfo: { flex: 1 },
  compactName: { fontSize: 14, fontWeight: '700', color: '#FFFFFF' },
  compactMeta: { fontSize: 11, color: '#6B7280', marginTop: 1 },
});
