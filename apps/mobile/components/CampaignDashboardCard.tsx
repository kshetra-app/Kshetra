...
const styles = StyleSheet.create({
  ...
  name: { fontSize: 17, fontWeight: '800', color: '#FFFFFF', marginBottom: 2 },
  politician: { fontSize: 12, color: '#6B7280', marginBottom: 14 },
  ...
  kpiLabel: { fontSize: 9, color: '#6B7280', fontWeight: '600' },
  budgetSection: { marginBottom: 12 },
  budgetHeader: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 4 },
  budgetLabel: { fontSize: 11, color: '#9CA3AF', fontWeight: '600' },
  budgetPct: { fontSize: 12, fontWeight: '800' },
  budgetBar: { height: 6, backgroundColor: '#1F2937', borderRadius: 3, overflow: 'hidden' },
  budgetBarFill: { height: '100%', borderRadius: 3 },
  bottomRow: { flexDirection: 'row', justifyContent: 'space-around', paddingTop: 12, borderTopWidth: 1, borderTopColor: '#1F2937' },
  bottomStat: { flexDirection: 'row', alignItems: 'center', gap: 4 },
  bottomStatText: { fontSize: 11, color: '#6B7280', fontWeight: '600' },
});
