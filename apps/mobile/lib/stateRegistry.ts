...
const registry: Record<string, StateData> = {
  ...
  UK: { info: STATES.UK, constituencies: [], hasGeoJSON: false, hasFullData: true, totalSeats: 70, loadedCount: 70 },
  ...
  MN: { info: STATES.MN, constituencies: [], hasGeoJSON: false, hasFullData: true, totalSeats: 60, loadedCount: 60 },
  ML: { info: STATES.ML, constituencies: [], hasGeoJSON: false, hasFullData: true, totalSeats: 60, loadedCount: 60 },
  MZ: { info: STATES.MZ, constituencies: [], hasGeoJSON: false, hasFullData: true, totalSeats: 40, loadedCount: 40 },
  NL: { info: STATES.NL, constituencies: [], hasGeoJSON: false, hasFullData: true, totalSeats: 60, loadedCount: 60 },
  TR: { info: STATES.TR, constituencies: [], hasGeoJSON: false, hasFullData: true, totalSeats: 60, loadedCount: 60 },
  SK: { info: STATES.SK, constituencies: [], hasGeoJSON: false, hasFullData: true, totalSeats: 32, loadedCount: 32 },
  AR: { info: STATES.AR, constituencies: [], hasGeoJSON: false, hasFullData: true, totalSeats: 60, loadedCount: 60 },
  PY: { info: STATES.PY, constituencies: [], hasGeoJSON: false, hasFullData: true, totalSeats: 30, loadedCount: 30 },
};
