...
export { getTNAllTrivia, getTNTriviaForConstituency, getTNTriviaForParty, getTNRandomTrivia } from '../../../data/seed/tamil-nadu-trivia';
...
export { getKLAllTrivia, getKLTriviaForConstituency, getKLTriviaForParty, getKLRandomTrivia } from '../../../data/seed/kerala-trivia';
...
export { getWBAllTrivia, getWBTriviaForConstituency, getWBTriviaForParty, getWBRandomTrivia } from '../../../data/seed/west-bengal-trivia';
...
export { getUPAllTrivia, getUPTriviaForConstituency, getUPTriviaForParty, getUPRandomTrivia } from '../../../data/seed/uttar-pradesh-trivia';
...
export { getBRAllTrivia, getBRTriviaForConstituency, getBRTriviaForParty, getBRRandomTrivia } from '../../../data/seed/bihar-trivia';
...
export { getJKAllTrivia, getJKTriviaForConstituency, getJKTriviaForParty, getJKRandomTrivia } from '../../../data/seed/jammu-kashmir-trivia';
...
export { getRJAllTrivia, getRJTriviaForConstituency, getRJTriviaForParty, getRJRandomTrivia } from '../../../data/seed/rajasthan-trivia';
...
export { getGJAllTrivia, getGJTriviaForConstituency, getGJTriviaForParty, getGJRandomTrivia } from '../../../data/seed/gujarat-trivia';
...
export { getDLAllTrivia, getDLTriviaForConstituency, getDLTriviaForParty, getDLRandomTrivia } from '../../../data/seed/delhi-trivia';
...
export { getPBAllTrivia, getPBTriviaForConstituency, getPBTriviaForParty, getPBRandomTrivia } from '../../../data/seed/punjab-trivia';
...
export { getHRAllTrivia, getHRTriviaForConstituency, getHRTriviaForParty, getHRRandomTrivia } from '../../../data/seed/haryana-trivia';
...
export { getCGAllTrivia, getCGTriviaForConstituency, getCGTriviaForParty, getCGRandomTrivia } from '../../../data/seed/chhattisgarh-trivia';
...
export { getMPAllTrivia, getMPTriviaForConstituency, getMPTriviaForParty, getMPRandomTrivia } from '../../../data/seed/madhya-pradesh-trivia';
...
export { getJHAllTrivia, getJHTriviaForConstituency, getJHTriviaForParty, getJHRandomTrivia } from '../../../data/seed/jharkhand-trivia';
...
export { getODAllTrivia, getODTriviaForConstituency, getODTriviaForParty, getODRandomTrivia } from '../../../data/seed/odisha-trivia';
...
export { getASAllTrivia, getASTriviaForConstituency, getASTriviaForParty, getASRandomTrivia } from '../../../data/seed/assam-trivia';
...
export { getGAAllTrivia, getGATriviaForConstituency, getGATriviaForParty, getGARandomTrivia } from '../../../data/seed/goa-trivia';
...
export { getHPAllTrivia, getHPTriviaForConstituency, getHPTriviaForParty, getHPRandomTrivia } from '../../../data/seed/himachal-pradesh-trivia';
...
export { getMNAllTrivia, getMNTriviaForConstituency, getMNTriviaForParty, getMNRandomTrivia } from '../../../data/seed/manipur-trivia';
...
export { getMLAllTrivia, getMLTriviaForConstituency, getMLTriviaForParty, getMLRandomTrivia } from '../../../data/seed/meghalaya-trivia';
...
export { getMZAllTrivia, getMZTriviaForConstituency, getMZTriviaForParty, getMZRandomTrivia } from '../../../data/seed/mizoram-trivia';
...
export { getNLAllTrivia, getNLTriviaForConstituency, getNLTriviaForParty, getNLRandomTrivia } from '../../../data/seed/nagaland-trivia';
...
export { getTRAllTrivia, getTRTriviaForConstituency, getTRTriviaForParty, getTRRandomTrivia } from '../../../data/seed/tripura-trivia';
...
export { getSKAllTrivia, getSKTriviaForConstituency, getSKTriviaForParty, getSKRandomTrivia } from '../../../data/seed/sikkim-trivia';
...
export { getARAllTrivia, getARTriviaForConstituency, getARTriviaForParty, getARRandomTrivia } from '../../../data/seed/arunachal-pradesh-trivia';
...
export { getUKAllTrivia, getUKTriviaForConstituency, getUKTriviaForParty, getUKRandomTrivia } from '../../../data/seed/uttarakhand-trivia';
...
export { getPYAllTrivia, getPYTriviaForConstituency, getPYTriviaForParty, getPYRandomTrivia } from '../../../data/seed/puducherry-trivia';
