...
const en =  {
  ...
  "campaignManager": {
    ...
    "obdPricingBreakdown": "Base telecom rate ₹0.60 + Kshetra platform margin 50% (₹0.30) = ₹0.90 per 30-sec call.",
    ...
    "metaPublishDesc": "Publish speeches and rally photos directly to your connected Facebook Page and Instagram. Boost packages include a 50% platform fee.",
