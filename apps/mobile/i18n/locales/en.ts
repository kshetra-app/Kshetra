...
const en = {
  ...
  leadershipAcademy: {
    ...
    legalNote:
      "Educational summary prepared from the public sources above. Videos are streamed from the original publisher's official channel with attribution and are not re-hosted. All trademarks belong to their respective owners.",
  ...
  delimitationExtended: {
    ...
    equalPopulation: 'Based on equal-population principle',
