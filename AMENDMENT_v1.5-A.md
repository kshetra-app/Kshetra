...
Every substantive implementation plan must conform to the following canonical 22-section specification:
...
Each section is mandatory. No section may be omitted, combined, or replaced with informal conversational text. Where specialized considerations arise (such as root-cause analysis, alternatives considered, exact file boundaries, test integrity, provenance, security/privacy, dependencies, or plan-approval state), they must be incorporated directly within the appropriate canonical section indicated above.
