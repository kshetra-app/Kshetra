...
| **W006** | API Architecture Audit & Separation | ARCH | IN PROGRESS | `3f88de3` | `tests/api-architecture-audit.test.mjs` (5/5 PASS); `scripts/audit-api-architecture.mjs` | `reports/w006_api_architecture_audit.json`, `reports/w006_api_architecture_report.md` | Audited 316 mobile files, 12 direct Supabase callers, 14 Railway callers, 114 Fastify routes across 23 modules, 85 data service methods classified (22 Class A reads, 57 Class B mutation strangler targets, 6 Class C Fastify routed) | - |
