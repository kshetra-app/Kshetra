...
| **W004** | Observability & Error Tracking | DEVOPS | REOPENED (W004-R1A) | `ef4622a` | W004-R1 (16/16 tests) + W004-R1A (+3 credential-separation tests = 19/19); request-ID hardening; production debug/metrics auth; error classification; mobile tracing; metrics credential separation from Supabase | `reports/w004_r1_*.json`, `reports/w004_r1_independent_verification.md`, `reports/w004_r1a_*.json` | Independent Audit Pending (W004-R1A) | - |
