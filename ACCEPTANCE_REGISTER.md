...
| **W000-REC2A**| Parser Implementation & Evidence Rebinding | ARCH | IN_VERIFICATION | `b78376a` | `tests/view-parser-regression.test.mjs` (imports real parser); `scripts/reconcile-w000.mjs` (23 views) | `reports/w000_rec2a_report.*`, `reports/w000_*.json` | In-repo verified | Pending IV |
